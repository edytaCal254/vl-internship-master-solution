...
public class FifteenPercentDiscountTest {
    ...
    @Test
    void shouldApply15PercentDiscountWhenThereIsAtLeast3GrainProducts() {
        // Given
        ...
        var expectedTotalPrice = bread.price().multiply(BigDecimal.valueOf(2))
                .add(cereals.price()).add(milk.price())
    ...
    @Test
    void shouldNotApply15PercentDiscountWhenThereIsLessThan3GrainProducts() {
        // Given
        var productDb = new ProductDb();
        var bread = productDb.getProduct("Bread");
        var cereals = productDb.getProduct("Cereals");
        ...
        var expectedTotalPrice = milk.price().multiply(BigDecimal.valueOf(2))
                .add(bread.price()).add(cereals.price());
